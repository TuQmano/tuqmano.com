...
tuits %>% 
  ...
  ggtern(aes(x = replies_count,
             y= retweets_count,
             z = likes_count, colour = username, fill= username))+
...
```{r rtweet, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE, eval = F}

  
  library(rtweet)

consulta <- get_timelines(user = c("mauriciomacri", "alferdez", "kicillofok", "mariuvidal"), n = 100)
