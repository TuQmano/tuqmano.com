...
Alison Horst (`Rstudio`) estuvo en la exposición inaugural contando qué es "Aprender sin una red". Maëlle Salmon expuso cómo [bloguear desde R Markdown](https://bloguearrr.netlify.app/). 	
...
In the oppening session Alison Horst talked about what is "Learning without a net". Maëlle Salmon showed us how to [blog from R Markdown](https://bloguearrr.netlify.app/). 	
